...
function RandomProject() {
  ...
  return (
    <div className="Container w-[100%] h-[100vh] flex flex-col justify-center items-center bg-[#DED0B6]">
      <h1 className="text-[38px] font-bold mb-[60px] bg-[#B2A59B] py-[10px] px-[10px] text-center rounded-[5px] w-[30%]">Random Number Generator</h1>
        ...
        <div className="mainDiv flex h-[450px] w-[80%] flex-col justify-evenly ">
          ...
          <div className="minMaxDiv flex justify-between w-[100%] ">
            <div className="minDiv flex flex-col gap-[5px] h-[60px] w-[45%] font-bold text-[20px]">
              <p>Minimum Value</p>
              <input value={minVal} onChange={e=>setMinVal(Number(e.target.value))} type="number" className="px-[5px] bg-[#FAEED1] w-[100%]" />
            </div>
            <div className="maxDiv flex flex-col gap-[5px] h-[60px] w-[45%] font-bold text-[20px]">
              <p>Maximum Value</p>
              <input value={maxVal} onChange={e=>setMaxVal(Number(e.target.value))} type="number" className="px-[5px] bg-[#FAEED1] w-[100%]" />
            </div>
          </div>
